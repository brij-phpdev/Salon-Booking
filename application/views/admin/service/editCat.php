...
<div class="main-panel">
    <div class="container">
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form enctype="multipart/form-data"  method="POST" action="<?php anchor_to(SERVICE_CONTROLLER . '/catEdit/' . $categories['id']) ?>">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="category-title">Package Name <span class="text-danger">*</span></label>
