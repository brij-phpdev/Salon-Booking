                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title float-left">Packages</div>
                            <a href="<?php anchor_to(SERVICE_CONTROLLER . '/catAdd') ?>" class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Add Package</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($services as $gCat ){ ?>
                                        <tr>
                                            <td><?php echo esc($gCat['cName'], true) ?></td>
                                            <th class="text-right"><?php echo esc($gCat['count'], true) ?></th>
                                            <td class="text-right">
                                                <a href="<?php anchor_to(SERVICE_CONTROLLER . '/catEdit/' . $gCat['id']) ?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-link btn-primary btn-lg">
                                        ...
                                        ?>
                                        <tr>
                                            <td class="text-center" colspan="3"><h4 class="text-muted">No Package Found</h4></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
